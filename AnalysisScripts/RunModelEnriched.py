...
def train_run_model(xData,yData, label1):
    ...
    plt.savefig(outputDir + 'EnrichedPerformance.png', bbox_inches = 'tight')
    #plt.show()
    ...
    #plt.show()
    plt.savefig(outputDir + 'EnrichedAUC.png',bbox_inches='tight')
...
enrichStats.to_csv(outputDir + 'EnrichmentModelPerformane.csv')
enrichImportance.to_csv(outputDir + 'EnrichedFeatureImportance.csv')
